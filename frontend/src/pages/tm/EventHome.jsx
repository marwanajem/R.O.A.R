  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        if (user?.clubCode) {
          const rosterRes = await fetch(`[https://roarchampionship.com](https://roarchampionship.com)/api/competitors/event/${id}/club/${user.clubCode}`)
          if (rosterRes.ok) {
        ...
        if (user?.clubCode) {
          ...
          //Teams/Pairs
          const teamRes = await fetch(`[https://roarchampionship.com](https://roarchampionship.com)/api/teams/event/${id}/club/${user.clubCode}`)
          if (teamRes.ok) {
