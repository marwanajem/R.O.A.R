...
// BACKEND: on submit, replace console.info with POST /api/events/:id/teams
...
export default function TeamBuilder() {
  ...
  const myCompetitors = allCompetitors.filter((c) => c.clubCode === user?.clubCode)
  ...
  function handleSubmit(e) {
    ...
    console.info('Team data (ready for API):', { category, members: selected, eventId: id })
